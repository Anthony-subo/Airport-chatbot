...
if openai_api_key is None:
    ...
    print(f"OpenAI API key found: {openai_api_key[:5]}...")  # Print first 5 characters to verify
...
def get_bot_response():
    ...
    language = request.form.get('language', 'english')  # Default to English if language not specified
    try:
        ...
        return jsonify({'response': "I'm sorry, I couldn't process your request at the moment."})
